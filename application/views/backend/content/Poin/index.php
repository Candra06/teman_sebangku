                        ...
                        <table class="table table-striped table-bordered data">
                          ...
                          <?php foreach($data as $dt) {?>
                            <tr>
                              <td><?= $dt['kd_poin'];?></td>        
                              <td><?= $dt['aksi'];?></td>
                              <td><?= $dt['jml_belanja'];?></td>
                              <td><?= $dt['jml_poin'];?></td>  
                              <td><?php if($dt['status']==1){echo 'Ditampilkan';}elseif($dt['status']==0){echo 'Tidak Ditampilkan';}?></td>
                                                          
                              <td>
                                <a href="<?= base_url().$this->uri->segment(1)."/Edit/$dt[kd_poin]"?>"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i>Edit</button></a>
