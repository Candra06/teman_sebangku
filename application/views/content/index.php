<head>
  ...
  <body>
    ...
    <!-- partial:partials/_navbar.html -->
      <?php
      include str_replace("system", "application/views/content/", BASEPATH)."/layout/head.php"; 
      ?>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php
      include str_replace("system", "application/views/content/", BASEPATH)."/layout/sidebar.php"; 
      ?>
      <!-- partial -->
      <div class="main-panel">
        <div class="content-wrapper">
           <?php
            include str_replace("system", "application/views/content/", BASEPATH)."/layout/content.php"; 
            ?> 
